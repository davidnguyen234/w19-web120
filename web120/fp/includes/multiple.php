...
?>
	...
	<div>	
		<fieldset>
			...
			<input type="checkbox" name="Interested_In[]" value="Logo Design" tabindex="40" /> Logo Design <br />
			<input type="checkbox" name="Interested_In[]" value="Branding Design" /> Branding Design<br />
			<input type="checkbox" name="Interested_In[]" value="Advertising Design" /> Advertising Design <br />
			<input type="checkbox" name="Interested_In[]" value="Print Design" /> Print Design <br />
